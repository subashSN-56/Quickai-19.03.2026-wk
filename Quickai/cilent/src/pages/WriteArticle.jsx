...
const WriteArticle = () => {
  ...
  const onSubmitHandler = async (e) => {
    ...
    try {
      ...
      const prompt = `
Write a high-quality, SEO-friendly article on the topic: "${input}".
  ...
  return (
    <div className="h-full overflow-y-auto p-6 flex items-start flex-wrap gap-4 text-slate-700">
      ...
      >
        ...
        <button
          disabled={loading}
          className={`w-full flex justify-center items-center gap-2 px-4 py-2 mt-6 text-sm rounded-lg text-white ${
            loading
              ? "bg-gray-400"
        ...
        {!content ? (
          <div className="flex-1 flex justify-center items-center">
            <div className="text-sm flex flex-col items-center gap-5 text-gray-400 text-center">
              ...
              <p>
                Start by entering a topic ✍️ <br />
                and generate a professional article instantly 🚀
              </p>
            </div>
          </div>
        ) : (
          <div className="mt-3 h-full overflow-y-auto pr-2 text-sm text-slate-600">
